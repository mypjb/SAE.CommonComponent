...
let configUrl = "http://api.sae.com/appdata/public?appid=wLmMfZoBskej00f-wMxF3w&env=Production";
...
if (ENV == "dev") {
    configUrl = "http://localhost:8080/appdata/public?appid=wLmMfZoBskej00f-wMxF3w&env=Development";
}
