...
let configUrl = "http://api.sae.com/appdata/public?appid=Wy1zfDFmmEOZWzuKumgXiQ&env=Production";
...
if (ENV == "dev") {
    configUrl = "http://localhost:8080/appdata/public?appid=Wy1zfDFmmEOZWzuKumgXiQ&env=Development";
}
