...
let configUrl = "http://api.sae.com/appdata/public?appid=BtIesq2MDU2fjGwVsvreOg&env=Production";
...
if (ENV == "dev") {
    configUrl = "http://localhost:8080/appdata/public?appid=BtIesq2MDU2fjGwVsvreOg&env=Development";
}
