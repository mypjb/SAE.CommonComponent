...
let configUrl = "http://api.sae.com/appdata/public?appid=1VMG394Sw06SUXc0gVVQwg&env=Production";
...
if (ENV == "dev") {
    configUrl = "http://localhost:8080/appdata/public?appid=1VMG394Sw06SUXc0gVVQwg&env=Development";
}
