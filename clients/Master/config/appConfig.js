...
let configUrl = "http://api.sae.com/appdata/public?appid=8vNildOotkeDAy0ywEXFQw&env=Production";
...
if (ENV == "dev") {
    configUrl = "http://localhost:8080/appdata/public?appid=8vNildOotkeDAy0ywEXFQw&env=Development";
}
