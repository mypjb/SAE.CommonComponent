...
let configUrl = "http://api.sae.com/appdata/public?appid=ntUIrb2asEy5qxQSnsDkYw&env=Production";
...
if (ENV == "dev") {
    configUrl = "http://localhost:8080/appdata/public?appid=ntUIrb2asEy5qxQSnsDkYw&env=Development";
}
