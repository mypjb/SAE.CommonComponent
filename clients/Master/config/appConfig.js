...
let configUrl = "http://api.sae.com/appdata/public?appid=F_vSo-IBxkWZTIFQk_1WAg&env=Production";
...
if (ENV == "dev") {
    configUrl = "http://localhost:8080/appdata/public?appid=F_vSo-IBxkWZTIFQk_1WAg&env=Development";
}
