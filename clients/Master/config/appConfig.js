...
let configUrl = "http://api.sae.com/appdata/public?appid=PvMb0EgG_kG1fDXLGo_nXA&env=Production";
...
if (ENV == "dev") {
    configUrl = "http://localhost:8080/appdata/public?appid=PvMb0EgG_kG1fDXLGo_nXA&env=Development";
}
