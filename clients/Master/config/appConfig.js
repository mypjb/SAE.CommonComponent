...
let configUrl = "http://api.sae.com/appdata/public?appid=rncSrEbMAke5pG_pWCxXmA&env=Production";
...
if (ENV == "dev") {
    configUrl = "http://localhost:8080/appdata/public?appid=rncSrEbMAke5pG_pWCxXmA&env=Development";
}
