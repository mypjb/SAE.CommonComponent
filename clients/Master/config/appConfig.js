...
let configUrl = "http://api.sae.com/appdata/public?appid=kkvrFe4ZKkGQj65j2-01xA&env=Production";
...
if (ENV == "dev") {
    configUrl = "http://localhost:8080/appdata/public?appid=kkvrFe4ZKkGQj65j2-01xA&env=Development";
}
