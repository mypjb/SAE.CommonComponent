...
let configUrl = "http://api.sae.com/appdata/public?appid=x4n4mLOhFUW_uAdje2eHNw&env=Production";
...
if (ENV == "dev") {
    configUrl = "http://localhost:8080/appdata/public?appid=x4n4mLOhFUW_uAdje2eHNw&env=Development";
}
