...
let configUrl = "http://api.sae.com/appdata/public?appid=3bdS1ZTPEE2s6Mf_8iLUQQ&env=Production";
...
if (ENV == "dev") {
    configUrl = "http://localhost:8080/appdata/public?appid=3bdS1ZTPEE2s6Mf_8iLUQQ&env=Development";
}
