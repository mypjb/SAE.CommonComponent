...
let configUrl = "http://api.sae.com/appdata/public?appid=uX16DIGAhUWYdXvp5mzKWQ&env=Production";
...
if (ENV == "dev") {
    configUrl = "http://localhost:8080/appdata/public?appid=uX16DIGAhUWYdXvp5mzKWQ&env=Development";
}
