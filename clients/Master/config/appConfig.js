...
let configUrl = "http://api.sae.com/appdata/public?appid=localhost.test.app&env=Production";
...
if (ENV == "dev") {
    configUrl = "http://localhost:8080/appdata/public?appid=localhost.dev.app&env=Development";
}
